...
export function WhyHGVSection() {
  ...
  return (
    <section id="why-hgv" className="bg-[#FAF8F2] py-16 sm:py-24 px-4 sm:px-8 lg:px-12 max-w-[1394px] mx-auto">
      {/* Header row */}
        ...
        >
          ...
          >
            ...
            <p
              ...
              style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, lineHeight: 1.35 }}
            >
              24–48 hour delivery{" "}
          ...
          >
            <div>
              <p
                ...
                style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, lineHeight: 1 }}
              >
                98%
              </p>
              <p
