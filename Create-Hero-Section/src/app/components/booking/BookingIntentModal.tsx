  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center px-4">
      <button
        ...
        onClick={onClose}
      />
      <div className="relative w-full max-w-[520px] bg-[#fffdf8] border border-[#d9d0c4] rounded-[20px] shadow-[0_28px_80px_rgba(15,29,47,0.35)] p-6 sm:p-8">
        <button
          type="button"
        ...
        <h3
          ...
          style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 600, lineHeight: 1.15 }}
        >
