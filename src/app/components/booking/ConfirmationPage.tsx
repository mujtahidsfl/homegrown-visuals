...
export function ConfirmationPage() {
  ...
  return (
    <section className="min-h-screen bg-[radial-gradient(circle_at_15%_0%,#eaf6ff_0%,#f4f8fc_50%,#ffffff_100%)] px-4 py-16">
      ...
      <div className="max-w-[920px] mx-auto">
        <div className="bg-white border border-[#dbe3ef] rounded-[20px] p-8 sm:p-10 shadow-[0_18px_40px_rgba(31,58,95,0.12)] text-center">
          ...
          <h1 className="text-[#1F3A5F] text-[42px] mt-4" style={{ fontFamily: "'PP Neue Montreal', 'Montserrat', 'Satoshi', sans-serif", fontWeight: 600 }}>
            You're all booked!
          </h1>
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center gap-3">
            <Link to="/services" className="h-11 px-6 rounded-full bg-[#1F3A5F] text-white flex items-center justify-center">
